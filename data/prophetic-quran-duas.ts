...
export const propheticQuranDuas: DuaItem[] = [
  {
    id: "prophetic-7-23",
    category: "prophetic",
    title: "Prophet Adam seeks forgiveness and mercy",
    theme: "Forgiveness",
    benefit:
    ...
    repetition: "Read it when turning back to Allah after a slip or sin.",
    authenticity: "quran",
  },
  {
    id: "prophetic-11-47",
    category: "prophetic",
    title: "Prophet Nuh seeks refuge from ignorant asking",
    theme: "Guidance",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Hud 11:47",
    sourceUrl: "https://quran.com/11/47",
    repetition: "Read it when asking Allah for restraint, clarity, and mercy.",
    authenticity: "quran",
  },
  {
    id: "prophetic-71-26",
    category: "prophetic",
    title: "Prophet Nuh asks protection from corruption",
    theme: "Protection",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Nuh 71:26",
    sourceUrl: "https://quran.com/71/26",
    repetition:
      "Read it when asking Allah to remove stubborn corruption and protect faith.",
    authenticity: "quran",
  },
  {
    id: "prophetic-71-28",
    category: "prophetic",
    title: "Prophet Nuh asks forgiveness for the believers",
    theme: "Forgiveness",
    benefit:
      "This dua gathers personal forgiveness, family concern, and sincere prayer for all believing men and women.",
    arabic:
      "رَّبِّ ٱغْفِرْ لِى وَلِوَٰلِدَىَّ وَلِمَن دَخَلَ بَيْتِىَ مُؤْمِنًا وَلِلْمُؤْمِنِينَ وَٱلْمُؤْمِنَـٰتِ وَلَا تَزِدِ ٱلظَّـٰلِمِينَ إِلَّا تَبَارًا",
    transliteration:
    ...
    sourceType: "quran",
    sourceReference: "Surah Nuh 71:28",
    sourceUrl: "https://quran.com/71/28",
    repetition:
      "Read it when making dua for yourself, your family, and the believers.",
    authenticity: "quran",
  },
  {
    id: "prophetic-2-127-129",
    category: "prophetic",
    title: "Prophet Ibrahim and Ismail ask acceptance and guidance",
    theme: "Guidance",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-Baqarah 2:127-129",
    sourceUrl: "https://quran.com/2/127-129",
    repetition:
      "Read it when asking Allah to accept worship and guide your family and community.",
    authenticity: "quran",
  },
  {
    id: "prophetic-14-35",
    category: "prophetic",
    title: "Prophet Ibrahim asks protection from idolatry",
    theme: "Protection",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Ibrahim 14:35",
    sourceUrl: "https://quran.com/14/35",
    repetition:
      "Read it when asking Allah to protect your home and family from false worship.",
    authenticity: "quran",
  },
  {
    id: "prophetic-14-37",
    category: "prophetic",
    title: "Prophet Ibrahim prays for hearts and provision",
    theme: "Prayer",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Ibrahim 14:37",
    sourceUrl: "https://quran.com/14/37",
    repetition:
      "Read it when asking Allah for prayer, belonging, and provision for your family.",
    authenticity: "quran",
  },
  {
    id: "prophetic-14-40",
    category: "prophetic",
    title: "Prophet Ibrahim asks to establish prayer",
    theme: "Prayer",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Ibrahim 14:40",
    sourceUrl: "https://quran.com/14/40",
    repetition:
      "Read it when asking Allah for steadfast prayer for yourself and your children.",
    authenticity: "quran",
  },
  {
    id: "prophetic-14-41",
    category: "prophetic",
    title: "Prophet Ibrahim asks forgiveness for his family and believers",
    theme: "Forgiveness",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Ibrahim 14:41",
    sourceUrl: "https://quran.com/14/41",
    repetition: "Read it when making dua for parents and the wider believing community.",
    authenticity: "quran",
  },
  {
    id: "prophetic-26-83-87",
    category: "prophetic",
    title: "Prophet Ibrahim asks for wisdom and honor in the Hereafter",
    theme: "Guidance",
    benefit:
      "This dua asks for wisdom, a truthful legacy, Paradise, forgiveness, and a protected standing on the Last Day.",
    arabic:
      "رَبِّ هَبْ لِى حُكْمًا وَأَلْحِقْنِى بِٱلصَّـٰلِحِينَ وَٱجْعَل لِّى لِسَانَ صِدْقٍ فِى ٱلْـَٔاخِرِينَ وَٱجْعَلْنِى مِن وَرَثَةِ جَنَّةِ ٱلنَّعِيمِ وَٱغْفِرْ لِأَبِىٓ إِنَّهُۥ كَانَ مِنَ ٱلضَّآلِّينَ وَلَا تُخْزِنِى يَوْمَ يُبْعَثُونَ",
    transliteration:
    ...
    sourceType: "quran",
    sourceReference: "Surah Ash-Shu'ara 26:83-87",
    sourceUrl: "https://quran.com/26/83-87",
    repetition:
      "Read it when asking Allah for wisdom, a good legacy, and a beautiful ending.",
    authenticity: "quran",
  },
  {
    id: "prophetic-37-100",
    category: "prophetic",
    title: "Prophet Ibrahim asks for a righteous child",
    theme: "Children",
    benefit:
    ...
    urdu: "(آپ ؑ نے دعا کی :) پروردگار ! مجھے ایک صالح بیٹا عطا فرما۔",
    sourceType: "quran",
    sourceReference: "Surah As-Saffat 37:100",
    sourceUrl: "https://quran.com/37/100",
    repetition: "Read it when asking Allah for righteous children.",
    authenticity: "quran",
  },
  {
    id: "prophetic-26-169",
    category: "prophetic",
    title: "Prophet Lut asks to be saved from wrongdoing",
    theme: "Protection",
    benefit:
    ...
    urdu: "پروردگار ! تو نجات دے مجھے اور میرے گھر والوں کو ان کے عمل سے",
    sourceType: "quran",
    sourceReference: "Surah Ash-Shu'ara 26:169",
    sourceUrl: "https://quran.com/26/169",
    repetition: "Read it when seeking safety from wrongdoing around you.",
    authenticity: "quran",
  },
  {
    id: "prophetic-29-30",
    category: "prophetic",
    title: "Prophet Lut asks for help against corruption",
    theme: "Protection",
    benefit:
    ...
    english: "Lot prayed, “My Lord! Help me against the people of corruption.”",
    urdu: "اس نے دعا کی : اے میرے پروردگار ! میری مدد فرما اس مفسد قوم کے خلاف",
    sourceType: "quran",
    sourceReference: "Surah Al-'Ankabut 29:30",
    sourceUrl: "https://quran.com/29/30",
    repetition:
      "Read it when asking Allah for support against corruption and oppression.",
    authenticity: "quran",
  },
  {
    id: "prophetic-12-101",
    category: "prophetic",
    title: "Prophet Yusuf asks to die in submission",
    theme: "Guidance",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Yusuf 12:101",
    sourceUrl: "https://quran.com/12/101",
    repetition:
      "Read it when asking Allah for gratitude, steadfast faith, and a good ending.",
    authenticity: "quran",
  },
  {
    id: "prophetic-20-25-32",
    category: "prophetic",
    title: "Prophet Musa asks for ease, clarity, and support",
    theme: "Prayer",
    benefit:
      "This dua asks Allah to open the heart, ease the task, clarify speech, and strengthen a person with support.",
    arabic:
      "قَالَ رَبِّ ٱشْرَحْ لِى صَدْرِى وَيَسِّرْ لِىٓ أَمْرِى وَٱحْلُلْ عُقْدَةً مِّن لِّسَانِى يَفْقَهُوا۟ قَوْلِى وَٱجْعَل لِّى وَزِيرًا مِّنْ أَهْلِى هَـٰرُونَ أَخِى ٱشْدُدْ بِهِۦٓ أَزْرِى وَأَشْرِكْهُ فِىٓ أَمْرِى",
    transliteration:
    ...
    sourceType: "quran",
    sourceReference: "Surah Taha 20:25-32",
    sourceUrl: "https://quran.com/20/25-32",
    repetition:
      "Read it before study, speaking, teaching, or carrying a difficult responsibility.",
    authenticity: "quran",
  },
  {
    id: "prophetic-28-16",
    category: "prophetic",
    title: "Prophet Musa asks forgiveness after wrongdoing",
    theme: "Forgiveness",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-Qasas 28:16",
    sourceUrl: "https://quran.com/28/16",
    repetition: "Read it when making sincere tawbah after a wrong action.",
    authenticity: "quran",
  },
  {
    id: "prophetic-28-24",
    category: "prophetic",
    title: "Prophet Musa asks for goodness in hardship",
    theme: "Hardship",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-Qasas 28:24",
    sourceUrl: "https://quran.com/28/24",
    repetition: "Read it in hardship when you feel in need of Allah's help and provision.",
    authenticity: "quran",
  },
  {
    id: "prophetic-7-151",
    category: "prophetic",
    title: "Prophet Musa asks forgiveness and mercy for himself and Harun",
    theme: "Mercy",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-A'raf 7:151",
    sourceUrl: "https://quran.com/7/151",
    repetition: "Read it when asking Allah for mercy for yourself and loved ones.",
    authenticity: "quran",
  },
  {
    id: "prophetic-21-83",
    category: "prophetic",
    title: "Prophet Ayyub calls on Allah in hardship",
    theme: "Hardship",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-Anbya 21:83",
    sourceUrl: "https://quran.com/21/83",
    repetition: "Read it in illness, trial, or prolonged hardship while hoping in Allah's mercy.",
    authenticity: "quran",
  },
  {
    id: "prophetic-21-87",
    category: "prophetic",
    title: "Prophet Yunus calls on Allah in distress",
    theme: "Mercy",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-Anbya 21:87",
    sourceUrl: "https://quran.com/21/87",
    repetition:
      "Read it in distress when you need relief, repentance, and nearness to Allah.",
    authenticity: "quran",
  },
  {
    id: "prophetic-3-38",
    category: "prophetic",
    title: "Prophet Zakariyya asks for a pure child",
    theme: "Children",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Ali 'Imran 3:38",
    sourceUrl: "https://quran.com/3/38",
    repetition: "Read it when asking Allah for righteous and pure offspring.",
    authenticity: "quran",
  },
  {
    id: "prophetic-19-4-6",
    category: "prophetic",
    title: "Prophet Zakariyya asks for an heir",
    theme: "Children",
    benefit:
      "This dua reflects vulnerability, lifelong hope, and trust in Allah even in old age and difficulty.",
    arabic:
      "قَالَ رَبِّ إِنِّى وَهَنَ ٱلْعَظْمُ مِنِّى وَٱشْتَعَلَ ٱلرَّأْسُ شَيْبًا وَلَمْ أَكُنۢ بِدُعَآئِكَ رَبِّ شَقِيًّا وَإِنِّى خِفْتُ ٱلْمَوَٰلِىَ مِن وَرَآءِى وَكَانَتِ ٱمْرَأَتِى عَاقِرًا فَهَبْ لِى مِن لَّدُنكَ وَلِيًّا يَرِثُنِى وَيَرِثُ مِنْ ءَالِ يَعْقُوبَ ۖ وَٱجْعَلْهُ رَبِّ رَضِيًّا",
    transliteration:
    ...
    sourceType: "quran",
    sourceReference: "Surah Maryam 19:4-6",
    sourceUrl: "https://quran.com/19/4-6",
    repetition:
      "Read it when asking Allah for a blessed heir and trusting Him beyond apparent limits.",
    authenticity: "quran",
  },
  {
    id: "prophetic-21-89",
    category: "prophetic",
    title: "Prophet Zakariyya asks not to be left alone",
    theme: "Children",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-Anbya 21:89",
    sourceUrl: "https://quran.com/21/89",
    repetition: "Read it when asking Allah for family, companionship, and a blessed legacy.",
    authenticity: "quran",
  },
  {
    id: "prophetic-27-19",
    category: "prophetic",
    title: "Prophet Sulayman asks for gratitude and righteous deeds",
    theme: "Gratitude",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah An-Naml 27:19",
    sourceUrl: "https://quran.com/27/19",
    repetition: "Read it when asking Allah for gratitude and deeds that please Him.",
    authenticity: "quran",
  },
  {
    id: "prophetic-46-15",
  ...
  },
  {
    ...
    sourceType: "quran",
    sourceReference: "Surah Sad 38:35",
    sourceUrl: "https://quran.com/38/35",
    repetition: "Read it when asking Allah for forgiveness and generous provision from Him.",
    authenticity: "quran",
  },
  {
    id: "prophetic-5-114",
    category: "prophetic",
    title: "Prophet Isa asks for a table from heaven",
    theme: "Gratitude",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-Ma'idah 5:114",
    sourceUrl: "https://quran.com/5/114",
    repetition: "Read it when asking Allah for provision joined with gratitude and a clear sign.",
    authenticity: "quran",
  },
  {
    id: "prophetic-20-114",
    category: "prophetic",
    title: "Prophet Muhammad asks for increase in knowledge",
    theme: "Knowledge",
    benefit:
    ...
    repetition: "Read it before study, reflection, or seeking beneficial knowledge.",
    authenticity: "quran",
  },
  {
    id: "prophetic-23-97-98",
    category: "prophetic",
    title: "Prophet Muhammad seeks refuge from evil whispers",
    theme: "Protection",
    benefit:
      "This dua asks Allah for refuge from satanic whispers and from their presence altogether.",
    arabic:
      "وَقُل رَّبِّ أَعُوذُ بِكَ مِنْ هَمَزَٰتِ ٱلشَّيَـٰطِينِ وَأَعُوذُ بِكَ رَبِّ أَن يَحْضُرُونِ",
    transliteration:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-Mu'minun 23:97-98",
    sourceUrl: "https://quran.com/23/97-98",
    repetition:
      "Read it when seeking protection from whispers, agitation, and spiritual disturbance.",
    authenticity: "quran",
  },
  {
    id: "prophetic-23-118",
    category: "prophetic",
    title: "Prophet Muhammad asks forgiveness and mercy",
    theme: "Mercy",
    benefit:
    ...
    sourceType: "quran",
    sourceReference: "Surah Al-Mu'minun 23:118",
    sourceUrl: "https://quran.com/23/118",
    repetition: "Read it often when asking Allah for forgiveness and mercy.",
    authenticity: "quran",
  },
];
